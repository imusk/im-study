package com.github.imusk.im.study.rocksdb.demo;
...
/**
 * @author: Musk
 * @data: 2020-07-28 23:16
 * @classname: RocksDBExample
 * @description: RocksDBExample
 */
public class RocksDBExample {

    private static final String dbPath   = "./rocksdb/db/rocksdb-data/";
    private static final String cfdbPath = "./rocksdb/db/rocksdb-data-cf/";
    ...
    public void testCertainColumnFamily() {
        System.out.println("ntestCertainColumnFamily begin...");
